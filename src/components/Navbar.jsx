    ...
    <div className='flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6'>
      <div className='lg:flex-1 flex flex-row max-w-[458px] py-2 pl-4 pr-2 h-[52px]
       bg-[#1c1c24] rounded-[100px]' >
        ...
        <input type='text' placeholder='Search for campaign' className='flex w-full font-epilogue font-normal text-[14px]
        placeholder:text-[#4b5264] text-white bg-transparent outline-nonte' />
      ...
      <div className="sm:hidden flex justify-between items-center relative">
        ...
        className='w-[34px] h-[34px] object-contatin cursor-pointer '
